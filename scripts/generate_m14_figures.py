...
Covers:
    ...
    - M14f:
        - results/tables/summary_table.md (Consolidated 5-method comparison table in Markdown)
        - results/tables/summary_table.csv (Consolidated 5-method comparison table in CSV)
"""
...
def main():
    print("=" * 70)
    print("Generating Module M14 evaluation figures & summary tables...")
    print("=" * 70)

    # --- M14a: Fig. 4 Trajectory comparison ---
    print("\n[1/8] Generating Fig. 4: 3-D flight trajectory comparison...")
    ...
    print("\n[2/8] Generating Fig. 5: Time-slot snapshots for all 5 methods...")
    ...
    print("\n[3/8] Generating Fig. 6: Real-time LoS probability & transmission rate...")
    ...
    print("\n[4/8] Generating Fig. 7(a): UAV position kernel density (10 flights)...")
    ...
    print("\n[5/8] Generating Fig. 7(b): Altitude density & user position density (10 flights)...")
    ...
    print("\n[6/8] Generating Fig. 8: Performance sweep vs. number of users k in [10..20]...")
    ...
    print("\n[7/8] Generating Fig. 9: Performance sweep vs. user mobility speed v_mob in (2, 4, 6, 8, 10, 12) m/s...")
    ...
    # --- M14f: Summary Table ---
    print("\n[8/8] Generating Consolidated Summary Table (Markdown + CSV)...")
    t0 = time.time()
    tables = generate_summary_table(
        seeds=range(10),
        k=10,
    )
    duration = time.time() - t0
    print(f"[OK] Summary Table (Markdown): {tables['markdown']} ({tables['markdown'].stat().st_size} bytes)")
    print(f"[OK] Summary Table (CSV): {tables['csv']} ({tables['csv'].stat().st_size} bytes, elapsed: {duration:.1f}s)")

    print("\n" + "=" * 70)
    print("All M14 figures and summary tables successfully generated.")
    print("=" * 70)
